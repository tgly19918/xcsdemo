...
class Oauth
{
    ...
    {      
        ...
        try {
            ...
            return $this->returnmsg(402,'无效身份验证凭据');
        }
    }
    ...
    {   
        ...
        try {
            ...
            $clientInfo['app_key'] = '2232xcsapiadmin1212';
        } catch (Exception $e) {
            return $this->returnmsg(402,$e.'无效身份验证凭据');
        }
        return $clientInfo;
    }
    ...
    public function certification($data = []){
        ...
        if(!$getCacheAccessToken){
            return $this->returnmsg(402,'token过期或错误！');
        }
        if($getCacheAccessToken['client']['app_key'] != $data['app_key']){

            return $this->returnmsg(402,'token与app_key不符合');  //app_key与缓存中的appkey不匹配
        }
